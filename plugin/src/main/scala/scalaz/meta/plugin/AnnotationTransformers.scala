...
trait AnnotationTransformers {
  ...
  abstract class AnnotatedClassTransformer(predicate: Symbol => Boolean) extends  analyzer.AnalyzerPlugin with analyzer.MacroPlugin {
